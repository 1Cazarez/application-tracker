...
const en = {
  ...
  'upload.subtitle': 'Upload a screenshot and let Gemini fill in the details, paste a listing to autofill instead, or enter them yourself.',
  ...
  'upload.pasteInstead': 'Paste a listing',
  'upload.enterManually': 'enter the details yourself',
  'upload.pasteTitle': 'Paste job details',
  'upload.pasteHint': "Paste the job posting text and we'll do our best to fill in the fields below for you to check.",
  'upload.pastePlaceholder': 'Paste the job posting text here...',
  'upload.autofill': 'Autofill details',
  ...
  'field.title': 'Title',
  'field.date_applied': 'Date applied',
...
const es: Record<TranslationKey, string> = {
  ...
  'upload.subtitle': 'Sube una captura y deja que Gemini complete los datos, pega una oferta para autocompletarlos, o ingrésalos tú mismo.',
  ...
  'upload.pasteInstead': 'Pega una oferta',
  'upload.enterManually': 'ingresa los datos tú mismo',
  'upload.pasteTitle': 'Pegar datos de la oferta',
  'upload.pasteHint': 'Pega el texto de la oferta de empleo y haremos lo posible por completar los campos para que los revises.',
  'upload.pastePlaceholder': 'Pega aquí el texto de la oferta de empleo...',
  'upload.autofill': 'Autocompletar datos',
  ...
  'field.title': 'Puesto',
  'field.date_applied': 'Fecha de solicitud',
